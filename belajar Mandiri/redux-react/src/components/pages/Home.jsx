...
const Home = ({open}) => {
  ...
  return (
    <main className={`py-24 relative w-100  h-full bg-slate-950 transition-all duration-700  overflow-y-scroll scrollbar-hide`}>
       ...
       <div className={`${open?"":"lg:pl-80 sm:pl-72"} absolute left-0 w-full flex flex-col gap-5 items-center`}>
         ...
         <div className={`grid ${open?"lg:grid-cols-3 lg:px-32 sm:px-24 lg:gap-12 gap-10 md:grid-cols-2 grid-cols-1 px-10":"lg:grid-cols-2 lg:px-[5rem] lg:gap-15 gap-10 xs:grid-cols-2 px-20"} h-full pb-5 w-full transition-all duration-300 ease-in-out`}>
            {Posts.map((post)=>(
